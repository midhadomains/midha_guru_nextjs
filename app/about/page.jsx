        ...
        <div className='max-w-[1400px] px-[10px] sm:px-[5%] xl:px-0 mx-auto py-9 sm:flex justify-around'>
          <div className='sm:w-[50%]'>
            ...
            <div className='sm:w-[50%] sm:hidden'>
              <Image height={650} width={650} className='m-3 w-[92%] rounded-xl' src="/About us heroImg-1.png" alt="About us heroImg" priority={true} />
            </div>
          ...
          <div className='sm:w-[50%] sm:flex flex-col justify-center hidden '>
            <Image height={650} width={650} className='lg:m-3 rounded-xl' src="/About us heroImg-1.png" alt="About us heroImg" priority={true} />
          </div>
        </div>
      </div>
      <div className=''>
        <div className='max-w-[1400px] px-[10px] sm:px-[5%] xl:px-0 mx-auto  py-9  sm:flex justify-around'>
          <div className='w-[92%] sm:flex flex-col justify-center mx-auto
           sm:w-[50%]'>
            <Image height={650} width={650} className='lg:m-3 max-w-[95%] rounded-xl' src="/About us heroImg-2.png" alt="About us heroImg" priority={true} />
          </div>
