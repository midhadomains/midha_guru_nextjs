...
const Card = ({ imageSrc, title, details }) => {
  ...
  return (
    <div
      className=" relative overflow-hidden border border-gray-300 rounded-md shadow-lg custom-transition  w-[350px] h-[180px] sm:w-[500px]  lg:w-[650px] lg:h-[300px] sm:m-4 mt-2"
