  ...
  return (
    <div>
      <div className="bg-[#F9F8F0] my-[30px]  pb-[30px]">
        ...
        <Image
          src="https://midha-images.s3.ap-south-1.amazonaws.com/MidhaGuru/Classroom+page/Structureofstudies.webp"
          alt="image"
          width={1500}
          height={400}
        ...
        />
        <Image
          src="https://midha-images.s3.ap-south-1.amazonaws.com/MidhaGuru/Classroom+page/Structureofstudies3.webp"
          alt="image"
          width={600}
          height={1000}
        ...
        />
        <Image
          src="https://midha-images.s3.ap-south-1.amazonaws.com/MidhaGuru/Classroom+page/Structureofstudies2.webp"
          alt="image"
          width={400}
          height={850}
