    ...
    <>
      ...
      >
        <div className="bg-[#6A1C1A] md:flex justify-center  hidden">
          ...
          >
            <MdCall className="mt-[6px] mr-2" />
            <h1>
              Call{" "}
              <span className=" ml-6 bg-[#8F4846] py-1 px-5 rounded-full font-[400] text-[18px] lg:text-[20px] my-auto">
                9506125061
              </span>
            </h1>
          </Link>
        ...
        <div className="">
          <div className="flex items-center justify-between  w-[100%] h-[55px] md:h-[70px] max-w-[2500px] mx-auto overflow:hidden">
            ...
            <ul className="hidden md:flex  justify-around flex-nowrap  max-w-[1000px] w-[100%]">
              ...
              <li>
                <div className="relative inline-block group py-[0.6rem] text-center">
                  ...
                  <div className="absolute -right-12 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-300 delay-50">
                    <ul>
                      <Link href="/classroom-coaching">
                        <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer">
                          Classroom Coaching
                        </li>
                      </Link>
                      <hr />
                      <Link href="https://edu.midha.guru/s/store">
                        <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer">
                          Online Courses
                        </li>
                      </Link>
              ...
              <Link
                href="https://edu.midha.guru/s/authenticate"
                className="text-[1.2rem] font-[500] cursor-pointer"
              >
            ...
            >
              ...
              <hr />
              <li className="text-[1.3rem] font-[700] pt-2 pb-0  px-5 hover:text-[#BE4E1E] text-[] ">
                Courses
              </li>
              <SmNavItem
                to="https://edu.midha.guru/s/store"
                name="Online Courses"
              />
