...
export default function Choose() {
  return (
    <div className="container max-w-[1330px] px-4 md:min-w-[900px] sm:min-w-[750px] 2xl:min-w-[1300px] mx-auto lg:px-0 p-8">
    
      <div className="mx-auto  ">
        <div className="flex flex-wrap sm:flex-nowrap justify-between">
         
        <div className=" relative overflow-hidden border border-gray-300 font-bold rounded-md shadow-md  w-[350px] h-[80px]  sm:w-[500px] sm:h-[190px] lg:w-[650px] lg:h-[300px]  mb-1 flex justify-center items-center sm:m-4">
